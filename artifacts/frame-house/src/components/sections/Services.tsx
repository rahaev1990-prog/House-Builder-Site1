      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-8 hover:bg-white/15 transition-colors flex flex-col"
              >
        ...
        >
          {[
            ...
            <div
              key={i}
              className="bg-white/5 border border-white/10 rounded-xl p-4 text-center text-sm font-medium text-gray-200 hover:bg-primary hover:text-white hover:border-primary transition-all cursor-default"
            >
              {item}
            </div>
          ))}
